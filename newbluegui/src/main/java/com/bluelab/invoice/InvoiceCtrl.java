...
public class InvoiceCtrl {
	...
	private void createColumns() {
		...
		colRepetion.setCellFactory(c -> new CheckBoxTableCell(true));

		colNoCost.setCellValueFactory(new PropertyValueFactory<>("nocost"));
		colNoCost.setCellFactory(c -> new CheckBoxTableCell(true));
		...
		colPaid.setCellFactory(c -> new CheckBoxTableCell(false));
	}
